...
export default function SingleCar() {
  ...
  return (
    <main className='text-white'>
      <article className='w-5/6 mx-auto w-100 px-20 py-40 rounded bg-slate-700 flex justify-evenly mt-20'>
          <div className='w-4/6'>
          ...
          <div className='w-2/6 pl-10'>
            ...
            <div className='mt-8 mb-8'>
              ...
              <button className={singleCarData.availability ? 'border p-4 rounded hover:bg-white hover:text-black' : 'border p-4 rounded opacity-40 cursor-default'} disabled={singleCarData.availability}>Rent now</button>
            </div>
            <div>
